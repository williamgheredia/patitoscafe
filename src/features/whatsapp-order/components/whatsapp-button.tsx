      ...
      <div className="bg-gradient-to-t from-[#FFF8F0] via-[#FFF8F0]/90 to-transparent pt-10 pb-4 px-4">
        <div className="max-w-lg mx-auto pointer-events-auto">
          ...
          >
            {/* Badge */}
            {hasItems && (
              <span className="absolute -top-2 -right-1 w-7 h-7 bg-[#F4A261] text-white text-xs font-black rounded-full flex items-center justify-center shadow-md animate-scale-in">
                {count}
              </span>
            )}
          ...
          {hasItems && (
            <p className="text-center text-sm text-[#3D2B1F]/50 mt-2.5 font-bold">
